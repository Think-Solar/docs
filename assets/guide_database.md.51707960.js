...
`,m=s('<h1 id="database" tabindex="-1">Database <a class="header-anchor" href="#database" aria-hidden="true">#</a></h1><p>An overview of the database schema</p><h2 id="schema" tabindex="-1">Schema <a class="header-anchor" href="#schema" aria-hidden="true">#</a></h2><ul><li>pipeline</li><li>pipeline_item</li><li>sales_pipeline_item</li><li>projects_pipeline_item</li></ul><h3 id="schema-diagram" tabindex="-1">Schema diagram <a class="header-anchor" href="#schema-diagram" aria-hidden="true">#</a></h3>',5),_={class:"w-full overflow-x-auto"},h={class:"mermaid w-auto"},g=JSON.parse('{"title":"Database","description":"","frontmatter":{"layout":"doc"},"headers":[{"level":2,"title":"Schema","slug":"schema","link":"#schema","children":[{"level":3,"title":"Schema diagram","slug":"schema-diagram","link":"#schema-diagram","children":[]}]}],"relativePath":"guide/database.md","lastUpdated":1674053737000}'),o={name:"guide/database.md"},K=Object.assign(o,{setup(p){return t(async()=>{e()}),(l,u)=>(n(),i("div",null,[m,a("div",_,[a("pre",h,"    "+r(d(c))+`
